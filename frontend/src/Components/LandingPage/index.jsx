...
function LandingPage(){
        ...
        return(
            ...
            <img src="/src/assets/spot_balls.png" alt='spot_balls' className=""/>
            ...
            <Link to="/home" ><button  className=' mx-auto text-xl md:text-2xl w-[230px] h-[44px] md:w-[253px] md:h-[58px] mt-4 bg-black text-white rounded-3xl  '  >Let's start</button></Link>
             <img src="/src/assets/Logo.png" alt="logo" className="  mt-4 m-auto w-[50px] h-[14px]  md:w-[61px] md:h-[17px] "/>
